package com.coffe.shentao.coffeechat.activity.groupinfo;
...
public class GetGroupInfoActivity extends Activity {
    ...
    private Button mBt_isGroupMemberKeepSilence;
    private Button mBt_getGroupSilenceMembersList;
...
//获取群组成员信息列表(userName)
        ...
        // 判断单个群成员是否被禁言
        mBt_isGroupMemberKeepSilence.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                info();
        ...
        // 获取群成员禁言列表（username)
        mBt_getGroupSilenceMembersList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                info();
                JMessageClient.getGroupInfo(mGetId, new GetGroupInfoCallback() {
...
//获取单个群成员信息(userName)
    ...
    private void initView() {
        ...
        mBt_isGroupMemberKeepSilence = (Button) findViewById(R.id.bt_is_group_member_keep_silence);
        mBt_getGroupSilenceMembersList = (Button) findViewById(R.id.bt_get_group_silence_members_list);
