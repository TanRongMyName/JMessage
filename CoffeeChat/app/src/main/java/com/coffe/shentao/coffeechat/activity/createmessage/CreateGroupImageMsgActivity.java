package com.coffe.shentao.coffeechat.activity.createmessage;
...
import com.coffe.shentao.coffeechat.utils.AndroidUtils;
                    ...
                    imageMessage.setOnSendCompleteCallback(new BasicCallback() {
                        ...
                        public void gotResult(int i, String s) {
                            if (i == 0) {
                                ...
                                Log.i(TAG, "JMessageClient.createGroupImageMessage " + ", responseCode = " + i + " ; LoginDesc = " + s);
                            }
                        }
                    });
